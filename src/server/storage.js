...
class Storage {
  ...
  initDatabase() {
    ...
    const newColumns = [
      ...
      'system_ttft REAL', 'system_latency_p50 REAL',
      'system_tps REAL', 'system_tpot REAL', 'system_gen_tps REAL',
      'concurrent_slots INTEGER'
    ];
    ...
    if (this.useJson) {
      ...
      this.db.prepare(`
        INSERT INTO benchmark_results (
          ...
          system_ttft, system_latency_p50, system_tps, system_tpot, system_gen_tps, concurrent_slots,
          raw_data, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).run(
        ...
        result.system_ttft ?? null, result.system_latency_p50 ?? null,
        result.system_tps ?? null, result.system_tpot ?? null, result.system_gen_tps ?? null,
        result.concurrent_slots ?? null,
